                ...
                <div className="row d-flex justify-content-center ">
                    ...
                    <div className="col-md-7 ">
                        <div className="col-md-12 mb-4 d-flex justify-content-center align-items-center education">
                            <h5>Education.</h5>
                            <img onClick={loadDetails} style={{ height: '16px' }} className="img-fluid" src={plus} alt="" />
                        </div>
                        <div className="col-12">
                            <p style={{fontFamily: 'Poppins', fontSize: '14px', marginLeft: '90px'}} id="details"></p>
                        </div>
                        <div className="col-md-12 mb-4 d-flex justify-content-center align-items-center cricket">
                            <h5>Performance.</h5>
                            <img onClick={loadDetails1} style={{ height: '16px' }} className="img-fluid" src={plus} alt="" />
                        </div>
                        <div className="col-12">
                            <p style={{fontFamily: 'Poppins', fontSize: '14px', marginLeft: '90px'}} id="details1"></p>
                        </div>
                        <div className="col-md-12 mb-4  d-flex justify-content-center align-items-center karate">
                            <h5>Opportunity.</h5>
                            <img onClick={loadDetails2} style={{ height: '16px' }} className="img-fluid" src={plus} alt="" />
                        </div>
                        <div className="col-12">
